...
# # Loop through the plot_list and save each plot
# for (i in seq_along(plot_list)) {
#   # Construct a file name for each plot
#   file_name <- paste0(path, "/plots/partial_dependence_plots/plot_", i, ".png")
#   
#   # Save the plot, adjust width and height as needed
#   ggsave(file_name, plot = plot_list[[i]], width = 8, height = 2, dpi = 300)
# }
...
# strengths
for (i in 1:length(bootstrap_models$models)) {
  interactions <- gbm.interactions(bootstrap_models$models[[i]])
